...
const sendOTPEmail = async (email, otp) => {
    ...
    // In dev mode: skip email, print OTP to console so any email can be tested
    if (isDev) {
        console.log("\n============================================")
        console.log("  📧  DEV MODE — OTP Email Skipped")
    ...
    // In production: send real email (requires verified Resend domain)
